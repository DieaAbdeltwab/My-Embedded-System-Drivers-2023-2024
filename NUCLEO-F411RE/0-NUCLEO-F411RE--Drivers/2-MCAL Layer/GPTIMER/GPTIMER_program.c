 ...
 ******************************************************************************
 */
uint8_t  MGPTIMER_u8CompareInterruptStatus ( GPTIMERindex_t Copy_GPTIMERindex , CompareInterruptIndex_t Copy_CompareInterruptIndex , CompareInterruptStatus_t Copy_CompareInterruptStatus )
{
	uint8_t Local_u8ErrorState = ERROR_STATE_OK ;
	if ( Copy_GPTIMERindex <= TMR_5 && Copy_CompareInterruptIndex <= CCIE_4 && Copy_CompareInterruptStatus<= CCIE_ENABLE )
	{
