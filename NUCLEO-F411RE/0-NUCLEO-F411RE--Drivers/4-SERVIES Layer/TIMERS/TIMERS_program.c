...
void STIMERS_voidDelayMS(uint32_t Copy_u32Milliseconds)
{
	...
	double Local_u32ProcessingTimeTemp=(160.5/8000);
 ...
 ******************************************************************************
 */
uint8_t STIMERS_u8SetPeriodicInterval   ( GPTIMERindex_t Copy_GPTIMERindex , uint32_t Copy_u32Ticks , void(*Copy_pFun)(void) )
{
	uint8_t Local_u8ErrorState = ERROR_STATE_OK ;
