...
void HLCD_voidInit(void)
{
  MSTK_u8ClockConfig(STK_AHB_DIV_8);
	...
	PinConfig_t Local_LCD_u8_DATA_PIN0 = {LCD_u8_DATA_PORT, LCD_u8_DATA_PIN0 ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_LCD_u8_DATA_PIN0);
	 //MGPIO_u8SetPinDirection(LCD_u8_DATA_PORT,LCD_u8_DATA_PIN1,OUTPUT_SPEED_2MHZ_PP);
	PinConfig_t Local_LCD_u8_DATA_PIN1 = {LCD_u8_DATA_PORT, LCD_u8_DATA_PIN1 ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_LCD_u8_DATA_PIN1);
	 //MGPIO_u8SetPinDirection(LCD_u8_DATA_PORT,LCD_u8_DATA_PIN2,OUTPUT_SPEED_2MHZ_PP);
	PinConfig_t Local_LCD_u8_DATA_PIN2 = {LCD_u8_DATA_PORT, LCD_u8_DATA_PIN2 ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_LCD_u8_DATA_PIN2);
	 //MGPIO_u8SetPinDirection(LCD_u8_DATA_PORT,LCD_u8_DATA_PIN3,OUTPUT_SPEED_2MHZ_PP);
	PinConfig_t Local_LCD_u8_DATA_PIN3 = {LCD_u8_DATA_PORT, LCD_u8_DATA_PIN3 ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_LCD_u8_DATA_PIN3);


	 //MGPIO_u8SetPinDirection(LCD_u8_CONTRAL_PORT,LCD_u8_RS_PIN,OUTPUT_SPEED_2MHZ_PP);
	PinConfig_t Local_LCD_u8_RS_PIN = {LCD_u8_CONTRAL_PORT, LCD_u8_RS_PIN ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_LCD_u8_RS_PIN);
	...
	PinConfig_t Local_LCD_u8_E_PIN = {LCD_u8_CONTRAL_PORT, LCD_u8_E_PIN ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_LCD_u8_E_PIN);
