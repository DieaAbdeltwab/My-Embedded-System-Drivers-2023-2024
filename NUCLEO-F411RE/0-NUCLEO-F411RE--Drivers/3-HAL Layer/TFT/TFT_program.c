...
void   HTFT_voidInit    ( void ) 
{
	...
	PinConfig_t Local_TFT_A0_PIN = {TFT_A0_PIN ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_TFT_A0_PIN);
	PinConfig_t Local_TFT_RESET_PIN = {TFT_RESET_PIN ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_TFT_RESET_PIN);
	//MGPIO_u8SetPinDirection( TFT_SCK       , OUTPUT_SPEED_10MHZ_AFPP );
	//MGPIO_u8SetPinDirection( TFT_MOSI      , OUTPUT_SPEED_10MHZ_AFPP );
	PinConfig_t MOSI  ={ TFT_MOSI , ALTERNATE_FUNCTION , SPEED_LOW , PUSH_PULL , NO_PULL , AF5 };
	MGPIO_u8PinInit(&MOSI);
	PinConfig_t SCK   ={ TFT_SCK  , ALTERNATE_FUNCTION , SPEED_LOW , PUSH_PULL , NO_PULL , AF5 };
	MGPIO_u8PinInit(&SCK);
