...
void ULTRASONIC_voidConfig   ( GPTIMERindex_t Copy_TMR , Channelindex_t Copy_ChannelTMR , ULTRASONICindex_t Copy_ULTRASONICindex )
{
	...
	PinConfig_t Local_ULTRASONIC_ECHO = {ULTRASONIC_ECHO_PORT, ULTRASONIC_ECHO_PIN ,ALTERNATE_FUNCTION,SPEED_LOW,PUSH_PULL,NO_PULL,AF1};
	MGPIO_u8PinInit(&Local_ULTRASONIC_ECHO);

	PinConfig_t Local_ULTRASONIC_TRIGGER = {ULTRASONIC_TRIGGER_PORT, ULTRASONIC_TRIGGER_PIN ,OUTPUT,SPEED_LOW,PUSH_PULL,NO_PULL,AF0};
	MGPIO_u8PinInit(&Local_ULTRASONIC_TRIGGER);
